...
$generateMessage = new GenerateMessage($container->get('service.fib.sequence'));
$publishMessage = new PublishMessage($container->get('fib.publisher'), new LimitChecker($count));
